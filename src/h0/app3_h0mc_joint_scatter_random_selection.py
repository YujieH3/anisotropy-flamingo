...
eY1 = data['e'+cf.COLUMNS_MC[yname1]][:].values   # in ratio 0-1
eX1 = data['e'+cf.COLUMNS_MC[xname1]][:].values
scat_obs_Y1 = np.log10(1 + eY1) 
scat_obs_X1 = np.log10(1 + eX1)

# Mock scatter for relation 2
eY2 = data['e'+cf.COLUMNS_MC[yname2]][:].values   # in ratio 0-1
eX2 = data['e'+cf.COLUMNS_MC[xname2]][:].values
...
z_obs = z_obs[select]
scat_obs_X1 = scat_obs_X1[select]
scat_obs_Y1 = scat_obs_Y1[select]
scat_obs_X2 = scat_obs_X2[select]
scat_obs_Y2 = scat_obs_Y2[select]
