...
MID_RANGE = (
    {  # round 5 sigma range to .5. Round up upper range and round down lower range
        "LX-T": {
            "logA_min": np.log10(1.0),
            "logA_max": np.log10(3.0),
            "B_min": 1.5,
            "B_max": 3.5,
            "scat_min": 0.05,
        ...
        "YSZ-T": {
            "logA_min": np.log10(0.5),
            "logA_max": np.log10(2.5),
            "B_min": 2,
            "B_max": 3.5,
            "scat_min": 0.05,
            "scat_max": 1,
...
FIVE_MAX_RANGE = {
    "LX-T": {
        "logA_min": np.log10(1.19),
        "logA_max": np.log10(1.84),
        "B_min": 1.69,
        "B_max": 3.31,
        "scat_min": 0.05,
        "scat_max": 1,
    ...
    "YSZ-T": {
        "logA_min": np.log10(0.80),
        "logA_max": np.log10(1.60),
        "B_min": 2.40,
        "B_max": 3.40,
        "scat_min": 0.05,
        "scat_max": 1,
    ...
    "M-T": {
        "logA_min": np.log10(0.93),
        "logA_max": np.log10(1.21),
        "B_min": 1.55,
        "B_max": 2.45,
        "scat_min": 0.05,
        "scat_max": 1,
    ...
    "LX-YSZ": {
        "logA_min": np.log10(2.27),
        "logA_max": np.log10(3.68),
        "B_min": 0.70,
        "B_max": 1.06,
        "scat_min": 0.05,
        "scat_max": 1,
    ...
    "LX-M": {
        "logA_min": np.log10(0.99),
        "logA_max": np.log10(1.46),
        "B_min": 1.09,
        "B_max": 1.42,
        "scat_min": 0.05,
        "scat_max": 1,
    ...
    "YSZ-M": {
        "logA_min": np.log10(3.11),
        "logA_max": np.log10(4.56),
        "B_min": 1.09,
        "B_max": 1.63,
        "scat_min": 0.05,
        "scat_max": 1,
...
ONE_MAX_RANGE_TIGHT_SCAT = {
    ...
    "YSZ-T": {
        "logA_min": np.log10(1.01),
        "logA_max": np.log10(1.12),
        "B_min": 2.62,
        "B_max": 2.84,
        "scat_min": 0.070,
        "scat_max": 1,
    ...
    "M-T": {
        "logA_min": np.log10(1.05),
        "logA_max": np.log10(1.11),
        "B_min": 1.91,
        "B_max": 2.08,
        "scat_min": 0.060,
        "scat_max": 1,
    ...
    "LX-YSZ": {
        "logA_min": np.log10(2.87),
        "logA_max": np.log10(3.18),
        "B_min": 0.81,
        "B_max": 0.92,
        "scat_min": 0.120,
        "scat_max": 1,
    ...
    "YSZ-M": {
        "logA_min": np.log10(3.63),
        "logA_max": np.log10(3.90),
        "B_min": 1.30,
        "B_max": 1.42,
        "scat_min": 0.075,
        "scat_max": 1,
...
THREE_MAX_RANGE_TIGHT_SCAT = {
    "LX-T": {
        "logA_min": np.log10(1.29),
        "logA_max": np.log10(1.76),
        "B_min": 1.96,
        "B_max": 2.95,
        "scat_min": 0.100,
        "scat_max": 1,
    ...
    "YSZ-T": {
        "logA_min": np.log10(0.90),
        "logA_max": np.log10(1.23),
        "B_min": 2.40,
        "B_max": 3.06,
        "scat_min": 0.075,
        "scat_max": 1,
    ...
    "LX-YSZ": {
        "logA_min": np.log10(2.56),
        "logA_max": np.log10(3.50),
        "B_min": 0.70,
        "B_max": 1.03,
        "scat_min": 0.120,
        "scat_max": 1,
    ...
    "LX-M": {
        "logA_min": np.log10(1.10),
        "logA_max": np.log10(1.36),
        "B_min": 1.14,
        "B_max": 1.36,
        "scat_min": 0.060,
        "scat_max": 1,
    ...
    "YSZ-M": {
        "logA_min": np.log10(3.36),
        "logA_max": np.log10(4.17),
        "B_min": 1.18,
        "B_max": 1.54,
        "scat_min": 0.075,
        "scat_max": 1,
...
LC0_BEST_FIT = {
    ...
    "M-T": {"A": 1.079, "B": 1.988, "scat": 0.070},
    "LX-YSZ": {"A": 3.027, "B": 0.862, "scat": 0.140},
    "LX-M": {"A": 1.225, "B": 1.244, "scat": 0.080},
    "YSZ-M": {"A": 3.759, "B": 1.360, "scat": 0.096},
}

LC1_BEST_FIT = {
    "LX-T": {"A": 1.542, "B": 2.446, "scat": 0.138},
    "YSZ-T": {"A": 1.099, "B": 2.782, "scat": 0.104},
    "M-T": {"A": 1.094, "B": 2.012, "scat": 0.072},
