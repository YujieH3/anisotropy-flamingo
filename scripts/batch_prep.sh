...
#SBATCH -J test #Give it something meaningful.
...
data_dir="/cosma8/data/do012/dc-he4/mock_lightcones_cp"  #directory of halo_properties_in_ligthcone0000.hdf5 (or 0001, 0002, etc.)
